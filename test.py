...
with open("Words\English Dota 2.txt", encoding="utf-8") as w:
    f = w.readlines()
    print(f)
    for _ in range(10):
...
# with open("Words\word.json", "w") as write_file:
##     json.dump(d, write_file)
#
# with open("Words\word.json", "r") as write_file:
#     x = json.load(write_file)
#     print(len(x))
#     print(x[])
...
class Main(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.ui2.pushButton.clicked.connect(self.bttn_action)
